...
No segundo exemplo ('00110000'), sendo a paridade PAR, o bit de paridade deve ser 0, do contrário, a paridade seria ÍMPAR e o bit de paridade no início da cadeia seria '1', tornando-a: '10110000'.

O tipo de PARIDADE escolhida ajudará a indicar que houve algum erro na transmissão da informação. No contexto dos caracteres da tabela ASCII, que são compostos de binários de 7 bits, o bit de paridade será adicionado com um peso a mais que o MSB da cadeia, formando uma cadeia de 8 bits.

Em cenários reais, esse tipo de verificação auxilia como indicativo da confiabilidade da informação transmitida. Esse código em Python é uma maneira de abstrair esse conceito com técnicas de programação, tratamento de erros e aplicação de engenharia de software para soluções cotidianas.
